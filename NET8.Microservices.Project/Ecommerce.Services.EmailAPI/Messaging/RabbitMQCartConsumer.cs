...
namespace Ecommerce.Services.EmailAPI.Messaging
{
    public class RabbitMQCartConsumer : BackgroundService
    {
        ...
        public RabbitMQCartConsumer(IConfiguration configuration, EmailService emailService)
        {
            ...
            _channel.QueueDeclare(_configuration.GetValue<string>("TopicAndQueueNames:EcommerceShoppingCartQueue"), false, false, false, null);
        }
        ...
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            _channel.BasicConsume(_configuration.GetValue<string>("TopicAndQueueNames:EcommerceShoppingCartQueue"), false, consumer);
