...
using Ecommerce.Services.AuthAPI.RabbitMQSender;
...
namespace Ecommerce.Services.AuthAPI.Controllers
{
    ...
    public class AuthAPIController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register([FromBody] RegistrationRequestDTO model)
        {
            ...
            _messageBus.SendMessage($"Registering User: {model.Email}", _configuration.GetValue<string>("TopicAndQueueNames:RegisterUserQueue"));
            return Ok(_response);
        }
